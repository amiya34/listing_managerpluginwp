            ...
            <?php if ( is_array( $group ) ) : ?>
                <?php foreach ( $group as $id ) : ?>
                    <div class="infobox-item">
                        ...
                        <div class="infobox-item-image" <?php if ( ! empty( $image_url ) ) : ?>style="background-image: url('<?php echo esc_attr( $image_url ); ?>');"<?php else : ?>style="background-image: url('<?php echo plugins_url('horizon'); ?>/assets/img/default-item.png');"<?php endif; ?>>

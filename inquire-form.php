...
<form method="post" action="<?php echo Listing_Manager_Utilities::get_current_url(); ?>" class="inquire-form">
    ...
    <input type="hidden" name="next" value="<?php echo Listing_Manager_Utilities::get_current_url(); ?>">
